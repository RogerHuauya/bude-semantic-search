...
// //     // Asegúrate de que file esté definido
// //     if (!file) {
...
// //     axios.post(`http://localhost:8000/image/${tmp}/`, formData, {
// //       headers: {
...
import axios from "axios";
import './Multimedia.css';
import sideImage1 from './assets/XiPu.gif'; 
const Multimedia = () => {
  const [topK, setTopK] = useState('');
  const [selectedOption, setSelectedOption] = useState('');
  const [result, setResult] = useState([]);
  ...
  return (
    <div className="query-container">
      <div className="main-content">
        ...
        <button onClick={downloadContent} className='bye'>Download Content</button>
        <div className="side-image-container">
                <img src={sideImage1} alt="Side 1" className="side-image1" />
        </div>
      </div>
      <div className="divider"></div>
      <div className="result">
