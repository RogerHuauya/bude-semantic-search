    ...
    class SampleLoader:
        ...
        def __next__(self):
            ...
            with self.lock1:
                ...
                # print(self.tids, self.batch_foremost.value, batch_current,
                # self.tids[batch_current], batch_size)
            ...
            with self.lock2:
                while (
                    ...
                    # print('wait', indices[0], batch_current,
                    # self.batch_rearmost.value)
                    self.condition.wait()
                self.condition.notify_all()
                # print('yield', indices[0], batch_current,
                # self.batch_rearmost.value)
